...
public class PawsConfigScreen<T extends ItemConvertible> extends HandledScreen<PawsConfigScreenHandler<T>> implements PositionedScreen {
    ...
    private static final int TOP_FRAME_X = 7;
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget
                ...
                .build());
        addDrawableChild(ButtonWidget
                .builder(Text.translatable("gui.playercollars.paw_configurator.filter.deny_all"), (btn) -> handleButtonClick(PawsConfigScreenHandler.BTN_DENY_ALL_ID))
                .dimensions(x + TOP_FRAME_X + TOP_FRAME_WIDTH / 2, y + TOP_FRAME_Y + TOP_FRAME_HEIGHT - BUTTON_HEIGHT, TOP_FRAME_WIDTH / 2, BUTTON_HEIGHT)
                .build());
    }
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, WIDGETS_TEXTURE, x + TOP_FRAME_X, y + TOP_FRAME_Y + TOP_FRAME_HEIGHT - 16, addingTags ? 0 : 16, 0, 16, 16, 32, 16);
    }
}
